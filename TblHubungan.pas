...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_hubungan set id_siswa="'+c1.Text+'",id_ortu="'+c2.Text+'",status_hub_anak= "'+Edit1.Text+'",keterangan="'+Edit2.Text+'" ,status_ortu="'+Edit3.Text+'" where id_hub="'+id+'"');
zqry1.ExecSQL;
...
id:=dg1.DataSource.DataSet.FieldByName('id_hub').AsString;
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tbl_hubungan where id_hub="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tbl_hubungan');
zqry1.Open;
