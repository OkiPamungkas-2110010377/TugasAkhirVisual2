...
begin
id:=dg1.DataSource.DataSet.FieldByName('id_walikelas').AsString;
ShowMessage('DATA BERHASIL DIUPDATE!'); //UPDATE
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_walikelas set nik= "'+Edit1.Text+'",nama="'+Edit2.Text+'",jenis_kelamin="'+c1.Text+'",pendidikan="'+Edit3.Text+'",telp="'+Edit4.Text+'",matpel="'+Edit5.Text+'",alamat="'+Edit6.Text+'",status="'+Edit7.Text+'" where id_walikelas="'+id+'"');
zqry1. ExecSQL;
...
id:=dg1.DataSource.DataSet.FieldByName('id_walikelas').AsString;
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tbl_walikelas where id_walikelas="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tbl_walikelas');
zqry1.Open;
