...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_siswa set nis= "'+Edit1.Text+'",nisn="'+Edit2.Text+'",nama_siswa="'+Edit3.Text+'",nik="'+Edit4.Text+'",tempat_lahir="'+Edit5.Text+'",tanggal_lahir="'+FormatDateTime('yyyy-mm-dd',dtp1.Date)+'",jenis_kelamin="'+c1.Text+'",alamat="'+Edit6.Text+'",telp="'+Edit7.Text+'",hp="'+Edit8.Text+'",status="'+Edit9.Text+'" where id_siswa="'+id+'"');
zqry1. ExecSQL;
