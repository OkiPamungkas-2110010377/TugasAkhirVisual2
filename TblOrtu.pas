...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_ortu set nik= "'+Edit1.Text+'",nama="'+Edit2.Text+'",pendidikan="'+Edit3.Text+'",pekerjaan="'+Edit4.Text+'",telp="'+Edit5.Text+'",alamat="'+Edit6.Text+'",jenis_kelamin="'+c1.Text+'",agama="'+Edit7.Text+'",status="'+Edit8.Text+'" where id_ortu="'+id+'"');
zqry1. ExecSQL;
