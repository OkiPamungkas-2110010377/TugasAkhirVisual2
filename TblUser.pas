...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_user set username= "'+Edit1.Text+'",password="'+Edit2.Text+'",level="'+Edit3.Text+'",status="'+Edit4.Text+'" where id_user="'+id+'"');
zqry1. ExecSQL;
...
id:=dg1.DataSource.DataSet.FieldByName('id_user').AsString;
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tbl_user where id_user="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tbl_user');
zqry1.Open;
